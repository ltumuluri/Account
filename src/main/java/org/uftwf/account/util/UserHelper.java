...
public class UserHelper {
    ...
    public StatusMessage needToUpdate(KeycloakUser existingUser, KeycloakUser newUserInfo, SSOClient client) {
        ...
        if (existingUser.getUserAttributes() != null && existingUser.getUserAttributes().get("zipCode") != null
                && newUserInfo.getUserAttributes() == null) {
            update = true;
        } else if (existingUser.getUserAttributes() != null && existingUser.getUserAttributes().get("zipCode") != null
                && newUserInfo.getUserAttributes() != null) {
